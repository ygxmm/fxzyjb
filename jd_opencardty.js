...
============Quantumultx===============
[task_local]
30 10 2-31/4 4 * jd_opencardty.js, tag=4月母婴宝贝趴-文具联合活动, enabled=true

*/
const $ = new Env('4月母婴宝贝趴-文具联合活动');
...
async function run() {
  try {
    ...
    let config = [
	{configCode:'35e7d1e312954db98308c658b8f6def5',configName:'4月母婴宝贝趴-文具联合活动'},
    ]
    for(let i in config){
      $.hotFlag = false
      let item = config[i]
